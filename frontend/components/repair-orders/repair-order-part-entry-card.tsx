      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex gap-4">
          ...
          <div>
            ...
            <div className="mt-2 inline-flex rounded-full border border-blue-400/30 bg-blue-500/10 px-2 py-1 text-xs font-semibold uppercase tracking-wide text-blue-200">
